/* This file must be placed in node_modules/hypermd/powerpack with the corresponding .d.ts

See notes on lines 19-23
*/
...
(function (mod){ //[HyperMD] UMD patched!
  ...
  /*plain env*/ mod(null, (this.HyperMD_PowerPack = this.HyperMD_PowerPack || {}, this.HyperMD_PowerPack["insert-file-with-firestore"] = {}), HyperMD.InsertFile);
    ...
    function Upload_One(file, callback) {
        console.log("\ninsert-file-with-firestore invoked!")
        //Upload file and get url from firestore here
        var image_url = "https://colorlib.com/wp/wp-content/uploads/sites/2/react-dev-tools-logo.jpg"
        //Then invoke callback with the image url returned from firestore
        callback(image_url)
    ...
    insert_file_1.defaultOption.fileHandler = exports.FirestoreFileHandler;
});
